...
function brand_recommend_goods($type, $brand, $cat = 0)
{
    ...
    if ($result === NULL)
    {
        ...
        $sql = 'SELECT g.goods_id, g.goods_name,g.act_title, g.market_price, g.shop_price AS org_price, g.promote_price, ' .
...
function brand_get_goods($brand_id, $cate, $size, $page, $sort, $order)
{
    ...
    /* 获得商品列表 */
    $sql = 'SELECT g.goods_id, g.goods_name,g.act_title, g.market_price, g.shop_price AS org_price, ' .
