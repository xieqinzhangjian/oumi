...
<?php endif; ?>
<span class="action-span1"><font color="#FF0000">欢迎您，<?php echo $this->_var['user_name']; ?>（管理员）</font> </span><span id="search_id" class="action-span1"><?php if ($this->_var['ur_here']): ?> - <?php echo $this->_var['ur_here']; ?><?php endif; ?></span>
