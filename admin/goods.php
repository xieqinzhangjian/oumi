...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    else
    {
     ...
     //dqy add start 2013-12-26
	 $sql = "select shop_price from ".$GLOBALS['ecs']->table('goods')." where goods_id = '$_REQUEST[goods_id]'";
	 $s_price = $GLOBALS['db']->getOne($sql);
	
	 //dqy add end 2013-12-26
    /* 处理商品数据 */
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, rank_integral, suppliers_id,act_title,peizhi)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$rank_integral', '$suppliers_id','$_POST[act_title]','$_POST[peizhi]')";
        }
        else
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_on_sale, is_alone_sale, is_shipping, goods_desc, add_time, last_update, goods_type, extension_code, rank_integral,act_title,peizhi)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', 0, '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$code', '$rank_integral','$_POST[act_title]','$_POST[peizhi]')";
        }
    }
    else
    {
        ...
        $sql .= "keywords = '$_POST[keywords]', " .
				...
				//dqy add start 2013-12-26
				$a = "select * from ".$GLOBALS['ecs']->table('test')." where goods_id = '$_REQUEST[goods_id]'";
				$list = $GLOBALS['db']->getAll($a);
				foreach($list as $key => $rows)
				{
					$day = gmdate('d',$rows['add_time'] +  $timezone * 3600);
					$day1 = gmdate('d',time() + $timezone * 3600);
					if($day == $day1)
					{
						$b = "delete from ".$GLOBALS['ecs']->table('test')." where id = '$rows[id]'";
						$GLOBALS['db']->query($b);
					}
				}
				$add_time = time();
			    $sql1 = "insert into ".$GLOBALS['ecs']->table('test')."(`goods_id`,`add_time`,`price`,`old_price`) values('$_REQUEST[goods_id]','$add_time','$shop_price','$s_price')";
	...
	//dqy add start 2013-12-26
	 ...
	 {
		 $add_time = time();
		 $sql = "insert into ".$GLOBALS['ecs']->table('test')."(`goods_id`,`add_time`,`price`,`old_price`) values('$goods_id','$add_time','$shop_price','$shop_price')";
	...
	/* 代码修改 By www.ecshop120.com 将下面这行代码注释掉 */
