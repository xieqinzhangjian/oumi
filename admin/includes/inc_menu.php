...
$modules['02_cat_and_goods']['05_question_manage']   = 'question_manage.php?act=list'; //代码增加 评论插件+
...
$modules['02_cat_and_goods']['price_batch']             = 'price_batch.php?act=add';   //代码增加 By www.68ecshop.com
