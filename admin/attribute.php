...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
	...
	/* 增加代码_start By www.ecshop120.com */
	$attr_id_www_ecshop120_com = $is_insert ? $db->insert_id() : $_POST['attr_id'];
	$msg_attr_www_ecshop120_com = $is_insert ?   $_LANG['add_ok']  : $_LANG['edit_ok'];
	if($_POST['is_attr_gallery'] == '1')
	{
		$sql_www_ecshop120_com="update " .$ecs->table("attribute"). " set  is_attr_gallery=0 where cat_id='".$_POST['cat_id']."' ";
		$db->query($sql_www_ecshop120_com);
	}
	$sql_www_ecshop120_com="update " .$ecs->table("attribute"). " set  is_attr_gallery='$_POST[is_attr_gallery]' where attr_id='$attr_id_www_ecshop120_com' ";
	$db->query($sql_www_ecshop120_com);
	sys_msg(sprintf($msg_attr_www_ecshop120_com, $attr['attr_name']), 0, $links);
	/* 增加代码_end By www.ecshop120.com */
