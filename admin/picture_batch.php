    ...
    else
    {
        ...
        while ($row = $GLOBALS['db']->fetchRow($res))
        {
            ...
            if ($watermark && file_exists(ROOT_PATH . $row['img_original']))
            {
                ...
                /*
				* 生成商品详情页图片_start By www.ecshop120.com
				...
				*/
				...
				/* 生成商品详情页图片_end By www.ecshop120.com */

				/* 将下面这行的    $dir . $file_name    改为 $image_middle By www.ecshop120.com  */
                ...
                if (!$image)
                {
                     @unlink($image_middle); //将前面这行的    $dir . $file_name    改为 $image_middle      By www.ecshop120.com
