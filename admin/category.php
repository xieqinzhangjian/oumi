...
if ($_REQUEST['act'] == 'insert')
{
 ...
 /* 代码增加_start Byjdy */
	...
	$cat['brand_qq']  = !empty($_POST['brand_www68ecshopcom']) ? $_POST['brand_www68ecshopcom'] : '';
	$cat['attr_www68ecshopcom']  = !empty($_POST['attr_qq']) ? $_POST['attr_qq'] : '';
