...
function insert_history()
{
    ...
    if (!empty($_COOKIE['ECS']['history']))
    {
        ...
        while ($row = $GLOBALS['db']->fetch_array($query))
        {
            ...
            $str.='<li class="recommend_goods_li" >
  <div class="mod_goods mod_goods_w60">
              <div class="mod_goods_img"> <a target="_blank" href="'.$goods['url'].'" class="img"><img src="'.$goods['goods_thumb'].'" alt="'.$goods['goods_name'].'" width="60" height="60" /></a></div>
              <div class="mod_goods_info"><p class="mod_goods_tit"><a target="_blank" href="'.$goods['url'].'">'.$goods['goods_name'].'</a> </p><p class="mod_goods_price"><span class="mod_price"><span>'.$goods['shop_price'].'</span></span></p></div></li>';
        }
